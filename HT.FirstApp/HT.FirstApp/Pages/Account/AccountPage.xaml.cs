...
namespace HT.FirstApp.Pages.Account
{
    public partial class AccountPage : ContentPage
    {
        ...
        void OnLogout(object sender, EventArgs args)
        {
            ...
            if (!UserTokenSettings.Current.HasExpiresIn())
            {
                UserSettings.Current.UpdateUser(new HT.FirstApp.Model.User());
                UserTokenSettings.Current.UpdateUserToken(new HT.FirstApp.Model.Token() { ExpiresIn = 0 });
        ...
        void OnEmail(object sender, EventArgs args)
        {
            ...
            {
                emailMessenger.SendEmail("476920650@qq.com", "来自 HT.FirstApp - "+ DependencyService.Get<IVersionName>().GetVersionName() + " 的客户端反馈", "");
            }
            else
            {
